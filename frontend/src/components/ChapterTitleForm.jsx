...
const ChapterTitleForm = ({chapterTitle,courseId,setChapter,chapterId}) => {
    ...
    const form = useForm({
      ...
      const submitHandler = async(editedData) => {
        try {
            const response = await axios.patch(`${import.meta.env.VITE_BASEURL}/courses/${courseId}/chapter/${chapterId}/editTitle`,editedData,{withCredentials:true})
